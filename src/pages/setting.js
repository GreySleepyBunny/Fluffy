            ...
            <form>
                ...
                <div className="form-group">
                    ...
                    <input
                        className="form-control"
                        type={"tel"}
                        defaultValue={stateData[columnDefs.calories.col]}
                        onBlur={e => {
                            EditField(e.target.value, columnDefs.calories.col);
                        }}
                    />
                </div>
                <div className="form-group">
                    ...
                    <input
                        ...
                        onBlur={e => {
                            EditField(e.target.value, columnDefs.brand.col);
                        }}
                    />
                </div>
                <div className="form-group">
                    ...
                    <input
                        className="form-control"
                        type="text"
                        defaultValue={stateData[columnDefs.foodType.col]}
                        onBlur={e => {
                            EditField(e.target.value, columnDefs.foodType.col);
                        }}
                    />
                </div>
                <div className="form-group">
                    ...
                    <input
                        ...
                        onBlur={e => {
                            EditField(e.target.value, columnDefs.flavor.col);
                        }}
                    />
                </div>
                <div className="form-group">
                    ...
                    <input
                        ...
                        onBlur={e => {
                            EditField(e.target.value, columnDefs.gel.col);
                        }}
                    />
                </div>
                ...
                <div className="form-group form-check">
                    ...
                    />
                    <label className="form-check-label" htmlFor="col-like">
                        喜歡？
                    </label>
                </div>
                <div className="form-group form-check">
                    ...
                    />
                    <label className="form-check-label" htmlFor="col-diarrhea">
                        拉肚肚？
                    </label>
                </div>
                <div className="form-group form-check">
                    ...
                    />
                    <label className="form-check-label" htmlFor="col-throwUp">
                        吐粗乃？
                    </label>
                </div>
                <div className="form-group">
                    ...
                    <textarea
                        ...
                        onBlur={e => {
                            EditField(e.target.value, columnDefs.others.col);
                        }}></textarea>
                </div>
                {props.processing ? (
                    ...
                    <>
                        ...
                        {props.IsEdit ? (
                            <button
                                type="button"
                                className="btn"
                                style={{ ...btn.secondary, float: "right" }}
